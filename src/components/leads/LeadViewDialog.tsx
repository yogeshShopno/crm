          ...
          <>
            ...
            {!isWon && (
              <button
                onClick={handleSave}
                disabled={saving}
                className="rounded-lg bg-secondary px-4 py-2 text-sm font-semibold text-white hover:bg-primary/90 disabled:opacity-50"
              >
                  ...
                  <div className="mb-6 p-4 bg-white border border-gray-200 rounded-xl">
                    ...
                    <div className="mt-3 space-y-1">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:ring-1 focus:ring-ring transition-all outline-none resize-none"
                      />
                    </div>
                    <button
                      onClick={handleAddFollowup}
                      disabled={!editNextDate || !followupNote || addingFollowup}
                      className="mt-3 w-full rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white hover:bg-primary/90 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                    >
                      {addingFollowup ? (
                      ...
                      <table className="w-full text-left text-sm">
                        ...
                        <tbody className="divide-y divide-gray-50">
                          {[...(followUpSearch ? filteredFollowUps : localFollowUps)].reverse().map((f, i) => (
                            <tr key={f._id || i} className={`hover:bg-gray-50/50 transition-colors ${f._id?.startsWith('temp_') ? 'animate-pulse bg-primary/5/30' : ''}`}>
                      ...
                      <div key={idx} className="flex items-center gap-3 p-2 bg-white rounded-lg border border-gray-200 hover:border-gray-300 transition-all">
                        ...
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            className="p-2 hover:bg-primary/5 rounded-lg transition-colors text-gray-600 hover:text-primary"
                            title="View"
                          >
